...
metadata {
	...
	definition (name: "Monoprice Door/Window Sensor as CO", namespace: "MikeMaxwell", author: "Mike Maxwell") {
...
preferences {
	...
	// UI tile definitions
	tiles(scale: 2) {
		multiAttributeTile(name:"co", type: "lighting", width: 6, height: 4){
			tileAttribute ("device.co", key: "PRIMARY_CONTROL") {
...
def sensorValueEvent(value) {
	if (value) {
    	createEvent(name: "co", value: "clear", descriptionText: "$device.displayName Carbon Monoxide is clear")
	} else {
		createEvent(name: "co", value: "detected", descriptionText: "$device.displayName detected Carbon Monoxide")
    }
}
